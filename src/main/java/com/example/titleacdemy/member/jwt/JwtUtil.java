package com.example.titleacdemy.member.jwt;
...
import com.example.titleacdemy.member.security.UserDetailsServiceImpl;
...
public class JwtUtil {
    ...
    @Value("${jwt.secret}") //application.properties에 선언해놓은 값을 가져온다
